...
class Id extends CI_Controller {
	...
	public function __construct(){
        ...
        $this->load->view("indonesia/head");
        $this->load->view('indonesia/navigation',$data);
    }
	public function index(){
        ...
        $this->load->view('indonesia/home-header-section',$data);
        $this->load->view('indonesia/home-about-section',$data);
        $this->load->view('indonesia/home-support-section',$data);
        //$this->load->view('home-galeries-section');
        //$this->load->view('indonesia/home-contact-section');
        $this->load->view('indonesia/footer',$data);
        //$this->load->view("indonesia/index",$data);
        $this->load->view("indonesia/script");
    ...
    public function aboutUs(){
        ...
        //$this->load->view('navigation',$data);
        $this->load->view('indonesia/header',$data);
        $this->load->view('indonesia/home-about-section',$data);
        $this->load->view('indonesia/home-about-continue-section',$data);
        $this->load->view('indonesia/footer',$data);
        $this->load->view("indonesia/script");
    }
    public function projects(){
        ...
        $this->load->view('indonesia/header', $data);
        $this->load->view('indonesia/projects-content-section'); 
        $this->load->view('indonesia/footer',$data);
        $this->load->view("indonesia/script");
    }
    public function distribution(){
        ...
        $this->load->view('indonesia/header', $data);
        $this->load->view('indonesia/distributions-content-section',$data);
        $this->load->view('indonesia/footer',$data);
        $this->load->view("indonesia/script");    
    }
    public function sermons(){
        ...
        $this->load->view('indonesia/header', $data);
        $this->load->view('indonesia/sermons-content-section',$data);
        $this->load->view('indonesia/footer',$data);
        $this->load->view("indonesia/script");   
    }
    ...
    public function contact(){
        ...
        $this->load->view('indonesia/header', $data);
        $this->load->view('indonesia/contact-content-section',$data); 
        $this->load->view('indonesia/contact');
        $this->load->view('indonesia/footer',$data);
    }
