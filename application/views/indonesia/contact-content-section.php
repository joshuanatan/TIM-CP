...
<section class="contact-page-area section-gap" style = "padding-top:120px; padding-bottom:120px">
    <div class="container">
        <div class="row">
            <h3 style = "text-align:center">Cara yang mudah untuk menghubungi TIM atau Pdt. Hasan Sutanto, D.Th. dengan mengirim surat elektronik ke alamat: <br><br>tim.for.book@gmail.com.<br>tim.for.book@yahoo.com.</h3>
            <!--<div class="col-lg-8">
