...
<header id="header" id="home">
    <div class="container main-menu">
        <div class="row align-items-center justify-content-between d-flex">
          <div id="logo">
            <a href="<?php echo base_url().$lang;?>/index"><img src="<?php echo base_url();?>assets/img/logo2.png" alt="" title="" /></a>
          </div>
          <nav id="nav-menu-container">
            <ul class="nav-menu">
                <?php foreach($navigation as $data){ ?> 
                <li><a href="<?php echo base_url().$lang;?>/<?php echo $data->links;?>"><?php echo $data->nama; ?></a></li>
                <?php }?>
