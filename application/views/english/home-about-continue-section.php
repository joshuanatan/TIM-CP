...
foreach($publicationInfo as $b){
    ...
    $tahun = "";
    $hlm = "";
    if($b->tahun_revisi != "" && $this->session->lang == "id"){ $tahun = "dicetak ulang tahun ".$b->tahun_revisi.";"; $hlm = "hlm.";}
    else if ($b->tahun_revisi != "" && $this->session->lang == "en"){ $tahun = "reprinted at  ".$b->tahun_revisi.", "; $hlm = "pages.";}
